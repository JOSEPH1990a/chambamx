...
?>
	<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">Lista de empresas  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Agregar empresa</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
				...
				<table id="dash-table" class="table table-striped table-bordered table-hover"  style="font-size:12px" cellspacing="0">
				  ...
				  <tbody>
				  	<?php 
				  		$mydb->setQuery("SELECT * FROM `t_compania`");
